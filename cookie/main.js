...
Game.Launch=function()
{
	...
	css.type='text/css';
	css.innerHTML='body .icon,body .crate,body .usesIcon{background-image:url(https://cdn.jsdelivr.net/gh/jackb0back/streamingAssets@latest/cookie/img/icons.png?v='+Game.version+');}';
	...
	Game.Load=function()
	{
		...
		Game.Loader.domain='https://cdn.jsdelivr.net/gh/jackb0back/streamingAssets@latest/cookie/img/';
	...
	Game.Init=function()
	{
		...
		l('versionNumber').innerHTML='v. '+Game.version+'<div id="httpsSwitch" style="cursor:pointer;display:inline-block;background:url(https://cdn.jsdelivr.net/gh/jackb0back/streamingAssets@latest/cookie/img/'+(Game.https?'lockOn':'lockOff')+'.png);width:16px;height:16px;position:relative;top:4px;left:0px;margin:0px -2px;"></div>'+(Game.beta?' <span style="color:#ff0;">beta</span>':'');
		...
		Game.attachTooltip(l('heralds'),function(){
			...
			str+='<div style="width:31px;height:39px;background:url(https://cdn.jsdelivr.net/gh/jackb0back/streamingAssets@latest/cookie/img/heraldFlag.png);position:absolute;top:0px;left:8px;"></div><div style="width:31px;height:39px;background:url(https://cdn.jsdelivr.net/gh/jackb0back/streamingAssets@latest/cookie/img/heraldFlag.png);position:absolute;top:0px;right:8px;"></div>';
		...
		Game.shimmerTypes={
			...
			'golden':{
				...
				initFunc:function(me)
				{
					...
					//set image
					var bgPic='https://cdn.jsdelivr.net/gh/jackb0back/streamingAssets@latest/cookie/img/goldCookie.png';
					...
					{
						me.wrath=1;
						if (Game.season=='halloween') bgPic='https://cdn.jsdelivr.net/gh/jackb0back/streamingAssets@latest/cookie/img/spookyCookie.png';
						else bgPic='https://cdn.jsdelivr.net/gh/jackb0back/streamingAssets@latest/cookie/img/wrathCookie.png';
					}
					else
					{
						me.wrath=0;
					...
					{
						bgPic='https://cdn.jsdelivr.net/gh/jackb0back/streamingAssets@latest/cookie/img/hearts.png';
						picX=Math.floor(Math.random()*8);
					}
					else if (Game.season=='fools')
					{
						bgPic='https://cdn.jsdelivr.net/gh/jackb0back/streamingAssets@latest/cookie/img/contract.png';
						if (me.wrath) bgPic='https://cdn.jsdelivr.net/gh/jackb0back/streamingAssets@latest/cookie/img/wrathContract.png';
					}
					else if (Game.season=='easter')
					{
						bgPic='https://cdn.jsdelivr.net/gh/jackb0back/streamingAssets@latest/cookie/img/bunnies.png';
			...
			'reindeer':{
				...
				initFunc:function(me)
				{
					...
					me.l.style.backgroundImage='url(https://cdn.jsdelivr.net/gh/jackb0back/streamingAssets@latest/cookie/img/frostedReindeer.png)';
					me.l.style.opacity='0';
			...
			else if (Game.onMenu=='stats')
			{
				...
				for (var i=0;i<Game.Milks.length;i++)
				{
					if (Game.milkProgress>=i)
					{
						...
						'<div class="prompt" style="text-align:center;padding-bottom:6px;white-space:nowrap;margin:0px;padding-bottom:96px;"><h3 style="margin:6px 32px 0px 32px;">'+milk.name+'</h3><div style="opacity:0.75;font-size:9px;">('+(i==0?'starter milk':('for '+Beautify(i*25)+' achievements'))+')</div><div class="line"></div><div style="width:100%;height:96px;position:absolute;left:0px;bottom:0px;background:url(https://cdn.jsdelivr.net/gh/jackb0back/streamingAssets@latest/cookie/img/'+milk.pic+'.png);"></div></div>'
						,'top')+' style="background:url(https://cdn.jsdelivr.net/gh/jackb0back/streamingAssets@latest/cookie/img/icons.png) '+(-milk.icon[0]*48)+'px '+(-milk.icon[1]*48)+'px;margin:2px 0px;" class="trophy"></div>';
					}
				}
				...
				if (Game.Has('A festive hat'))
				{
					for (var i=0;i<=Game.santaLevel;i++)
					{
						...
						'<div class="prompt" style="text-align:center;padding-bottom:6px;white-space:nowrap;margin:0px 32px;"><div style="width:96px;height:96px;margin:4px auto;background:url(https://cdn.jsdelivr.net/gh/jackb0back/streamingAssets@latest/cookie/img/santa.png) '+(-i*96)+'px 0px;filter:drop-shadow(0px 3px 2px #000);-webkit-filter:drop-shadow(0px 3px 2px #000);"></div><div class="line"></div><h3>'+Game.santaLevels[i]+'</h3></div>'
						,'top')+' style="background:url(https://cdn.jsdelivr.net/gh/jackb0back/streamingAssets@latest/cookie/img/santa.png) '+(-i*48)+'px 0px;background-size:'+(frames*48)+'px 48px;" class="trophy"></div>';
					}
				...
				if (Game.Has('A crumbly egg'))
				{
					for (var i=0;i<=mainLevels.length;i++)
					{
						if (Game.dragonLevel>=mainLevels[i])
						{
							...
							//'<div style="width:96px;height:96px;margin:4px auto;background:url(https://cdn.jsdelivr.net/gh/jackb0back/streamingAssets@latest/cookie/img/dragon.png?v='+Game.version+') '+(-level.pic*96)+'px 0px;"></div><div class="line"></div><div style="min-width:200px;text-align:center;margin-bottom:6px;">'+level.name+'</div>'
							'<div class="prompt" style="text-align:center;padding-bottom:6px;white-space:nowrap;margin:0px 32px;"><div style="width:96px;height:96px;margin:4px auto;background:url(https://cdn.jsdelivr.net/gh/jackb0back/streamingAssets@latest/cookie/img/dragon.png?v='+Game.version+') '+(-level.pic*96)+'px 0px;filter:drop-shadow(0px 3px 2px #000);-webkit-filter:drop-shadow(0px 3px 2px #000);"></div><div class="line"></div><h3>'+level.name+'</h3></div>'
							,'top')+' style="background:url(https://cdn.jsdelivr.net/gh/jackb0back/streamingAssets@latest/cookie/img/dragon.png?v='+Game.version+') '+(-level.pic*48)+'px 0px;background-size:'+(frames*48)+'px 48px;" class="trophy"></div>';
						}
					}
		...
		Game.Object=function(name,commonName,desc,icon,iconColumn,art,price,cps,buyFunction)
		{
			...
			this.rebuild=function()
			{
				...
				*/
				...
				//l('productIcon'+me.id).style.backgroundImage='url(https://cdn.jsdelivr.net/gh/jackb0back/streamingAssets@latest/cookie/img/'+icon+')';
				l('productIcon'+me.id).style.backgroundPosition='-'+icon[0]+'px -'+icon[1]+'px';
				//l('productIconOff'+me.id).style.backgroundImage='url(https://cdn.jsdelivr.net/gh/jackb0back/streamingAssets@latest/cookie/img/'+iconOff+')';
		...
		order=40000;
		new Game.Upgrade('Magic shenanigans','Cookie production <b>multiplied by 1,000</b>.<q>It\'s magic. I ain\'t gotta explain sh<div style="display:inline-block;background:url(https://cdn.jsdelivr.net/gh/jackb0back/streamingAssets@latest/cookie/img/money.png);width:16px;height:16px;position:relative;top:4px;left:0px;margin:0px -2px;"></div>t.</q>',7,[17,5]);//debug purposes only
		Game.last.pool='debug';
		...
		Game.BankAchievement('Brought to you by the letter <div style="display:inline-block;background:url(https://cdn.jsdelivr.net/gh/jackb0back/streamingAssets@latest/cookie/img/money.png);width:16px;height:16px;"></div>');
		...
		*/
		...
		Game.ToggleSpecialMenu=function(on)
		{
			if (on)
			{
				...
				var str='<div id="specialPic" style="position:absolute;left:-16px;top:-64px;width:96px;height:96px;background:url(https://cdn.jsdelivr.net/gh/jackb0back/streamingAssets@latest/cookie/img/'+pic+');background-position:'+(-frame*96)+'px 0px;filter:drop-shadow(0px 3px 2px #000);-webkit-filter:drop-shadow(0px 3px 2px #000);"></div>';
